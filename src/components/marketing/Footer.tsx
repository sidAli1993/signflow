      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.linksCol}>
            ...
            <Link href="/templates" className={styles.link} style={{ fontWeight: 700, color: 'var(--color-primary, #4f46e5)' }}>Templates Library →</Link>
          ...
          <div className={styles.linksCol}>
            ...
            <Link href="/reviews" className={styles.link} style={{ fontWeight: 700, color: 'var(--color-primary)' }}>Reviews & Testimonials</Link>
            ...
            <Link href="/blog/what-is-a-disregarded-entity" className={styles.link}>What is a Disregarded Entity?</Link>
            <Link href="/blog/georgia-esignature-law-mandates-guide" className={styles.link}>Georgia eSignature Laws</Link>
          </div>
        ...
        {/* Product Hunt Badge */}
        <div className={styles.phBadgeWrapper}>
          <div className={styles.phBadgeCard}>
            <div className={styles.phBadgeHeader}>
              <img alt="Digital signature" src="https://ph-files.imgix.net/d93e131a-5778-49a5-8fb4-349236f7a616.png?auto=compress,format&codec=mozjpeg&cs=strip&fit=crop&h=80&w=80" className={styles.phBadgeImage} />
              <div className={styles.phBadgeTextContainer}>
                <h3 className={styles.phBadgeTitle}>Digital signature</h3>
                <p className={styles.phBadgeSubtitle}>Free online digital signature maker and PDF signing tool.</p>
              </div>
            </div>
            <a href="https://www.producthunt.com/products/digital-signature-2?embed=true&utm_source=embed&utm_medium=post_embed" target="_blank" rel="noopener noreferrer" className={styles.phBadgeLink}>Check it out on Product Hunt →</a>
          </div>
        </div>
