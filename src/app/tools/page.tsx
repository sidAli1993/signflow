...
const toolsList = [
  ...
  },
  {
    ...
    title: 'Sign Lease Agreement Online',
    badge: 'New',
    category: 'Signature',
    description: 'Sign residential or commercial lease agreements securely. 100% browser-based with zero server uploads.',
    icon: '🏠',
    searchKeywords: ['sign lease agreement online', 'sign lease online free'],
  },
  {
    slug: 'sign-employment-contract-online',
    title: 'Sign Employment Contract Online',
    badge: 'New',
    category: 'Signature',
    description: 'Sign employment contracts and job offer letters free. Your HR documents never leave your device.',
    icon: '💼',
    searchKeywords: ['sign employment contract online', 'sign job contract'],
  },
  {
    slug: 'sign-offer-letter-online',
    title: 'Sign Offer Letter Online',
    badge: 'New',
    category: 'Signature',
    description: 'Accept your new job instantly. Sign offer letters electronically and download them in under 60 seconds.',
    icon: '✉️',
    searchKeywords: ['sign offer letter online', 'accept job offer online'],
  },
  {
    slug: 'sign-invoice-online',
    title: 'Sign Invoice Online',
    badge: 'New',
    category: 'Signature',
    description: 'Add a professional digital signature to any invoice PDF. Free, no account, fully local processing.',
    icon: '🧾',
    searchKeywords: ['sign invoice online', 'invoice signature free'],
  },
  {
    slug: 'sign-waiver-online',
    title: 'Sign Waiver Online',
    badge: 'New',
    category: 'Signature',
    description: 'Sign liability waivers and release forms securely in your browser. ESIGN compliant and entirely free.',
    icon: '⚠️',
    searchKeywords: ['sign waiver online', 'sign liability release'],
  },
  {
    slug: 'sign-medical-form-online',
    title: 'Sign Medical Forms Online',
    badge: 'New',
    category: 'Signature',
    description: 'Sign patient intake and HIPAA forms securely. No server uploads means your health data stays private.',
    icon: '🏥',
    searchKeywords: ['sign medical form online', 'sign hipaa form'],
  },
  {
    slug: 'sign-consent-form-online',
    title: 'Sign Consent Form Online',
    badge: 'New',
    category: 'Signature',
    description: 'Sign parental, travel, or medical consent forms in seconds. Legally binding and 100% free.',
    icon: '✔️',
    searchKeywords: ['sign consent form online', 'esign consent form'],
  },
  {
    slug: 'sign-real-estate-contract-online',
    title: 'Sign Real Estate Contracts',
    badge: 'New',
    category: 'Signature',
    description: 'Sign purchase agreements and property disclosures instantly. Secure client-side processing.',
    icon: '🏡',
    searchKeywords: ['sign real estate contract online', 'sign purchase agreement'],
  },
  {
    slug: 'sign-freelance-contract-online',
    title: 'Sign Freelance Contracts',
    badge: 'New',
    category: 'Signature',
    description: 'Lock in projects by signing freelance agreements online. Free tools for independent contractors.',
    icon: '💻',
    searchKeywords: ['sign freelance contract online', 'freelance signature maker'],
  },
  {
    slug: 'sign-business-agreement-online',
    title: 'Sign Business Agreements',
    badge: 'New',
    category: 'Signature',
    description: 'Sign vendor contracts and partnership agreements with corporate-grade client-side privacy.',
    icon: '🤝',
