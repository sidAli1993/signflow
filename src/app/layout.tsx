...
export const metadata: Metadata = {
  title: {
    default: "Online Sign PDF Free — No Upload, No Account | MyDigitSign",
    template: "%s | MyDigitSign",
  },
  description: "Online sign PDF free. Draw electronic signature, digitally sign documents, sign files online — 100% private, no uploads, no account required.",
  keywords: [
    // Top GSC performing keywords (highest priority)
    "online sign pdf",
