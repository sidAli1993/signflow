      ...
      <section className={styles.seoExplainer}>
        <div className={styles.seoExplainerInner}>
          ...
          <div className={styles.seoArticle} style={{ marginTop: '4rem' }}>
            ...
            <p style={{ marginBottom: '1.25rem', lineHeight: 1.7, color: 'var(--color-text-secondary)' }} dangerouslySetInnerHTML={{ __html: 'Freelance agreements, Non-Disclosure Agreements (NDAs), and Statements of Work (SOW) are fully legally binding when executed with an electronic signature. This allows you to collaborate with clients anywhere in the world.' }} />
            <p style={{ marginBottom: '1.25rem', lineHeight: 1.7, color: 'var(--color-text-secondary)' }} dangerouslySetInnerHTML={{ __html: 'MyDigitSign is the perfect tool for freelancers because it is 100% free and requires no subscription. You can sign unlimited contracts and immediately download the finalized PDFs to send to your clients.' }} />
