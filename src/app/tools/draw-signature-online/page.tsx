...
export const metadata: Metadata = {
  ...
  description:
    'Create an electronic signature free using your mouse, trackpad, or touchscreen. Generate a free digital signature online and download a transparent PNG instantly.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Draw Signature Online Free — Create Digital Signatures | MyDigitSign',
    description:
      'Create an electronic signature free using your mouse, trackpad, or touchscreen. Generate a free digital signature online instantly.',
    creator: '@mydigitsign',
    images: ['/og-image.png'],
  },
};
...
const softwareSchema = getSoftwareAppSchema({
  name: 'MyDigitSign Signature Drawing Tool',
  description: 'Create an electronic signature free using mouse or touch input with instant transparent PNG export.',
  url: 'https://mydigitsign.com/tools/draw-signature-online',
});
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Click the Draw tab on MyDigitSign, then drag your cursor on the canvas to sketch your handwritten mark. You can change pen colors, clear the board, and save your signature as a transparent PNG or apply it directly to PDFs.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. After sketching your autograph, click Download PNG to save a high-resolution transparent image. You can insert this graphic into Word documents, Google Docs, invoices, or email footers.',
      },
    },
    {
      '@type': 'Question',
      name: 'Are online signatures created on touchscreen phones legal?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Online signatures generated via mobile touchscreens carry full legal validity under the ESIGN Act (US), eIDAS (EU), and international e-commerce regulations for business contracts and NDAs.',
      },
    },
    {
      '@type': 'Question',
      name: 'Is my handwritten autograph stored on any server?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Drawing produces a freehand autograph unique to your hand movement, whereas typing uses styled cursive typography. Both methods create legally binding online signatures.',
      },
    },
  ],
};
...
const howToSchema = getHowToSchema({
  ...
  steps: [
    {
      name: 'Select the Drawing Tool',
      text: 'Open the tool workspace and activate the Draw tab.',
      url: 'https://mydigitsign.com/tools/draw-signature-online',
    },
    {
    ...
    {
      name: 'Save or Embed',
      text: 'Click Adopt Signature to attach it directly to a PDF, or select Download PNG for a transparent graphic file.',
      url: 'https://mydigitsign.com/tools/draw-signature-online',
    },
  ],
});
  ...
  return (
    <div className={styles.appWrapper}>
      ...
      <section className={styles.seoHero} aria-label="About Draw Signature Online Tool">
        <div className={styles.seoHeroInner}>
          ...
          <p className={styles.seoHeroDesc}>
            Need a reliable way to generate a <strong>free digital signature online</strong>? Sketch your handwritten mark with a mouse, trackpad, or smartphone display. Create an <strong>electronic signature free</strong> of charge without watermarks, sign documents locally, or export a crisp transparent PNG in seconds.
          </p>
      ...
      <HomeClient 
        ...
        descriptionOverride="Sketch your mark on the interactive canvas below. Choose an ink color, then adopt it for PDF signing or export a transparent PNG image."
      />
        ...
        <div className={styles.seoExplainerInner}>
          ...
          <div className={styles.seoStepsGrid}>
            <article className={styles.seoStep}>
              ...
              <p>
                Use your mouse, trackpad, or finger to write your autograph on the digital pad. Use the clear control to start over whenever you want.
              </p>
            </article>
            <article className={styles.seoStep}>
              ...
              <p>
                Switch between professional black, traditional navy blue, or distinct red ink to complement your official forms.
              </p>
            </article>
            <article className={styles.seoStep}>
              <div className={styles.seoStepNum} aria-hidden="true">3</div>
              <h3>Export PNG or Sign PDF</h3>
              <p>
                Adopt your new mark to sign PDF contracts directly, or save a transparent PNG file to paste into Google Docs and Word files.
              </p>
            </article>
          </div>
          ...
          <div className={styles.seoCompare} style={{ marginTop: '2.5rem' }}>
            ...
            <ul className={styles.seoCompareList}>
              ...
              <li>✅ <strong>Transparent Background</strong> — blends cleanly over lines and text fields in any editor</li>
          ...
          <div className={styles.seoArticle} style={{ marginTop: '2.5rem' }}>
            ...
            <p style={{ marginBottom: '1rem', lineHeight: 1.6, color: 'var(--color-text-secondary)' }}>
              In today's fast-moving digital economy, waiting for paper documents to be printed, signed by hand, scanned, and emailed back is a major bottleneck. Managing <strong>online signatures</strong> electronically saves time, reduces paper waste, and speeds up deal closures. However, many online tools lock basic features behind monthly subscriptions or degrade your file with intrusive watermarks unless you upgrade to a paid account.
            </p>
            <p style={{ marginBottom: '1rem', lineHeight: 1.6, color: 'var(--color-text-secondary)' }}>
              MyDigitSign provides a clean, web-first alternative. We believe everyone should have access to an <strong>electronic signature free</strong> of charge, without forced account registrations or trial paywalls. Our client-side signature pad renders smooth Bezier curves in real time so your freehand strokes look natural, whether drawn using a optical mouse or a precision stylus.
            </p>
            <p style={{ marginBottom: '1rem', lineHeight: 1.6, color: 'var(--color-text-secondary)' }}>
              Because our rendering engine operates 100% inside your web browser, your sensitive data never travels to a remote server. You enjoy maximum privacy while generating a <strong>free digital signature online</strong> for immediate business or personal use.
            </p>
            ...
            <p style={{ marginBottom: '1rem', lineHeight: 1.6, color: 'var(--color-text-secondary)' }}>
              One major advantage of exporting your mark as a transparent PNG is versatility. Once saved to your local drive, you can reuse your graphic across multiple office platforms:
            </p>
            <ul style={{ lineHeight: 1.8, color: 'var(--color-text-secondary)', paddingLeft: '1.25rem', marginBottom: '1.5rem' }}>
              ...
              <li><strong>Email Signatures:</strong> Add your PNG graphic directly to your Gmail or Outlook signature settings for a custom sign-off on correspondence.</li>
            </ul>
          </div>
          ...
          <div className={styles.seoFaq} style={{ marginTop: '3rem' }}>
            ...
            <div className={styles.seoFaqGrid}>
              <div className={styles.faqItem}>
                ...
                <p>Open the Draw tab, use your mouse or finger to sketch your autograph on the canvas, and click Adopt Signature or Download PNG to save it instantly.</p>
              </div>
              <div className={styles.faqItem}>
              ...
              <div className={styles.faqItem}>
                <h3>Can I download a transparent PNG of my autograph?</h3>
                <p>Yes. Clicking Download PNG saves a transparent image file that seamlessly overlays text lines in Word, Google Docs, or PDF files.</p>
              </div>
              <div className={styles.faqItem}>
                <h3>Are online signatures drawn with a mouse legally binding?</h3>
                <p>Yes. Freehand electronic signatures have full legal standing under the ESIGN Act (US) and eIDAS (EU) for standard business contracts, agreements, and forms.</p>
              </div>
              <div className={styles.faqItem}>
                <h3>What is the difference between drawing and typing a signature?</h3>
                <p>Drawing yields a unique handwritten stroke pattern, while typing renders your name in cursive typography. Both methods are legally recognized for electronic signing.</p>
              </div>
            </div>
          </div>
