      ...
      <section className={styles.seoExplainer}>
        <div className={styles.seoExplainerInner}>
          ...
          <div className={styles.seoArticle} style={{ marginTop: '4rem' }}>
            ...
            <p style={{ marginBottom: '1.25rem', lineHeight: 1.7, color: 'var(--color-text-secondary)' }} dangerouslySetInnerHTML={{ __html: 'Electronic signatures are legally valid for providing consent. Whether you are a parent authorizing a school activity or an individual signing a photography release, an e-signature serves as a formal record of your agreement.' }} />
            <p style={{ marginBottom: '1.25rem', lineHeight: 1.7, color: 'var(--color-text-secondary)' }} dangerouslySetInnerHTML={{ __html: 'Our free signature tool allows you to apply your mark and date the form in seconds. Best of all, no account registration is required, allowing you to complete the task and move on with your day.' }} />
